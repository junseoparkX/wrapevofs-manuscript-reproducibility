...
handled by ``render_locking_simulation.ps1``.
"""
...
COLORS = {
    ...
    "competing": "#6F8F78",
    "misleading": "#A65E3B",
    "highest_score": "#4F7188",
    "legacy_top3_medoid": "#727A82",
    "full_bank_medoid": "#B1843E",
}
LABELS = {
    "aligned": "Aligned",
    "competing": "Competing",
...
def main() -> None:
    ...
    manifest = {
        ...
        "builder": "scripts/build_locking_simulation.py",
