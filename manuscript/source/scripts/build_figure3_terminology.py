...
def main() -> None:
    ...
    svg = FIGURES / "figure_3_source.svg"
    pregrid = FIGURES / "figure_3_pregrid.png"
    tree.write(svg, encoding="utf-8", xml_declaration=True)
    render_manifest = SOURCE_ROOT / "revision_outputs" / "FIGURE3_RENDER.json"
    ...
    provenance = {
        ...
        "output": str(output.relative_to(SOURCE_ROOT)).replace("\\", "/"),
        "output_sha256": sha256(output),
    }
    (SOURCE_ROOT / "revision_outputs" / "FIGURE3_TERMINOLOGY_PROVENANCE.json").write_text(
