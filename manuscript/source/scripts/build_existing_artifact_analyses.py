...
OUT = SOURCE_ROOT / "revision_outputs"
SUPPLEMENTARY_DATA = SOURCE_ROOT / "supplementary_data"
...
def write_provenance() -> None:
    ...
    provenance = {
        "operation": "existing-artifact-only reviewer analyses",
        "ga_rerun": False,
        "rfecv_rerun": False,
    ...
    (OUT / "EXISTING_ARTIFACT_ANALYSIS_PROVENANCE.json").write_text(
