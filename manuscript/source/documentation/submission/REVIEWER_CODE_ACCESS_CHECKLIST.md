...
- [x] All six main and 27 Supplementary figures are mapped to their presentation builders or archived source routes and machine-readable summary inputs in `documentation/FIGURE_SOURCE_DATA_MANIFEST.csv`.
