...
These three aggregate CSV files reproduce the current main Figure 5. No participant-level matrix, identifier, or prediction row is included.
...
```sh
python manuscript/source/scripts/validate_cgga_figure5_provenance.py
```
