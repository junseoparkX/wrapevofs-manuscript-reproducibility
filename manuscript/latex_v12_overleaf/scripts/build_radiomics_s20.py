...
COLORS = {"full_1781": "#2B6CB0", "stable_1346": "#D97706"}
...
def draw_seed_agreement(ax: plt.Axes, stability: pd.DataFrame) -> None:
    ...
    ax.scatter(x - 0.10, ordered["mean_pairwise_jaccard_all_five"], color="#2B6CB0", marker="o", s=26,
               label="Mean Jaccard")
    ax.scatter(x + 0.10, ordered["nogueira_stability_all_five"], color="#C05621", marker="D", s=21,
               label="Nogueira")
    ax.axhline(0, color="#4A5568", linewidth=0.7)
    labels = [
