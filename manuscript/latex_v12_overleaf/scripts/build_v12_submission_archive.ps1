param(
    ...
    [string]$OutputZip = (Join-Path (Split-Path -Parent (Split-Path -Parent $PSScriptRoot)) 'WrapEvoFS_LaTeX_V12_Nature_Submission.zip')
)
...
$fixedTimestamp = [System.DateTimeOffset]::Parse('2026-08-08T00:00:00-07:00')
